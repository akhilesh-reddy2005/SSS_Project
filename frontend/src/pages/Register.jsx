    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="glass-panel w-full max-w-sm p-7 sm:p-8 rounded-2xl relative z-10 animate-fade-in-up">
        <div className="text-center flex flex-col items-center mb-6">
          <div className="relative flex items-center justify-center w-14 h-14 rounded-xl bg-gradient-to-tr from-cyan-500 to-indigo-600 shadow-lg shadow-cyan-500/30 mb-4">
        ...
        <form className="space-y-5" onSubmit={handleSubmit}>
          ...
          <div className="pt-1">
            <button type="submit" disabled={loading} className="btn-primary w-full py-3 flex items-center justify-center shadow-cyan-500/25 from-cyan-600 to-indigo-600 hover:from-cyan-500 hover:to-indigo-500">
              {loading ? (
